...
def entradadevariables():
    valor_de_phi_grados = float(input("Ingrese el valor de phi en grados: "))
    valor_de_phi_minutos = float(input("Ingrese el valor de phi en minutos: "))
    valor_de_phi_segundos = float(input("Ingrese el valor de phi en segundos: "))
    ...
    Calculo_de_phi_decimal = valor_de_phi_grados + valor_de_phi_minutos/60 + valor_de_phi_segundos/3600
    Calculo_de_phi_radianes = m.radians(Calculo_de_phi_decimal)
    ...
    return (Calculo_de_alpha_radianes,Calculo_de_z1_radianes,Valor_H1, Distancia, Calculo_de_phi_radianes) 

def Calculos_Niv (Calculo_de_alpha_radianes, Calculo_de_z1_radianes, a, e,Valor_H1,Distancia, Calculo_de_phi_radianes):
    calculo_N =  a / m.sqrt(1 - e * (m.sin(Calculo_de_phi_radianes)**2))
    calculo_p = a*(1-e)/(1 - e * (m.sin(Calculo_de_phi_radianes)**2))**(3/2)
    ...
    Sen_1seg = 0.00000484813681107636782
    K_z_1 = 0.429
    K_z_2 =  Distancia/(Sen_1seg * Calculo_P_final)
    K_z_f = K_z_1 * K_z_2
    A = 1 + Valor_H1/Calculo_P_final
    Comp_B_1 = 90 + K_z_f
    Comp_B_1_1 = m.radians(Comp_B_1)
    Comp_B = m.tan(Comp_B_1_1 - Calculo_de_z1_radianes)
...
a,e = elipsoides()
Calculo_de_alpha_radianes,Calculo_de_z1_radianes, Valor_H1,Distancia,Calculo_de_phi_radianes =entradadevariables()
Calculos_Niv (Calculo_de_alpha_radianes, Calculo_de_z1_radianes,a, e,Valor_H1,Distancia,Calculo_de_phi_radianes)
