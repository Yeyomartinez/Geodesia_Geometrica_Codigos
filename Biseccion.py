...
def calculo_cordenadas_punto_p(
    ...
    if hiang > delta:
        ...
        Norte_p = ((valor_de_Eb - valor_de_Ea) + valor_de_Na * ctg_beta + valor_de_Nb * ctg_alpha) / z
        Este_p = ((valor_de_Na - valor_de_Nb) + valor_de_Ea * ctg_beta + valor_de_Eb * ctg_alpha) / z
        ...
        print("Método 2")
        ctg_beta = 1 / m.tan(Calculo_de_alpha_radianes)
        ctg_alpha = 1 / m.tan(Calculo_de_beta_radianes)
        z = ctg_alpha + ctg_beta

        Norte_p = ((valor_de_Eb - valor_de_Ea) + valor_de_Nb * ctg_beta + valor_de_Na * ctg_alpha) / z
        Este_p = ((valor_de_Na- valor_de_Nb) + valor_de_Eb * ctg_beta + valor_de_Ea * ctg_alpha) / z
